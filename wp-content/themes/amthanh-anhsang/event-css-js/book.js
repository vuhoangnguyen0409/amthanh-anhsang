...
$('#submit').click(function(){
    ...
    if (!$("input[name='rdoMusic']:checked").val()) {
        $('#error').html('<div class="error-bg"><i class="icon icon-cancel-circle"></i>Vui lòng chọn loại Âm Thanh</div>');
    ...
    if (!$("input[name='rdoLight']:checked").val()) {
        $('#error').html('<div class="error-bg"><i class="icon icon-cancel-circle"></i>Vui lòng chọn loại Ánh Sáng</div>');
